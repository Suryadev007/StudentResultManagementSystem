...
?>
                                            ...
                                            <span class="name">Number of Student</span>
                                            <span class="bg-icon"><i class=""></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
...
?>
                                            ...
                                            <span class="name">Number of Subject</span>
                                            <span class="bg-icon"><i class=""></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
...
?>
                                            ...
                                            <span class="name">Number of Results Declared</span>
                                            <span class="bg-icon"><i class=""></i></span>
                                        </a>
                                        <!-- /.dashboard-stat -->
                                    </div>
